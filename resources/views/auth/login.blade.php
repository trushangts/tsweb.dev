...
<body class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    @php $login_bg = url('/public/assets/img/login-bg.jpg'); @endphp
    <div class="page-header login-page header-filter" filter-color="purple" style="background-image: url('{{$login_bg}}'); background-size: cover; background-position: top center;">
            ...
            {{ csrf_field() }}
              ...
              <div class="card card-login card-hidden">
                ...
                <div class="card-footer justify-content-center">
                  ...
                  <input type="submit" class="btn btn-rose btn-link btn-lg" name="submit" value="Lets Go">
                </div>
              </div>
            </form>
  ...
  <script src="{{ url('/public/assets/js/material-dashboard.min.js?v=2.1.0') }}" type="text/javascript"></script>
  ...
  <!-- Sharrre libray -->
  <!-- <script src="{{ url('/public/assets/js/demo/jquery.sharrre.js') }}"></script> -->
